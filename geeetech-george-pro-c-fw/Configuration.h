...
#define STRING_CONFIG_H_AUTHOR "(George Robles georges3dprinters.com, GT2560 Dual Extruder)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "GT Pi3 Pro C"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.375,80.325,2560,95}  // CDS correction
...
#define EXTRUDER_OFFSET_X {0.0, 32.0} // (in mm) for each extruder, offset of the hotend on the X axis
